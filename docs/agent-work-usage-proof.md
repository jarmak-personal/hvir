...
and Claude transcripts are scanned incrementally with bounded individual-record and cumulative
artifact sizes. Oversized Codex records invalidate older counters until a later valid cumulative
record restores them. Either provider's artifact becomes explicitly unavailable rather than
partially parsed after it exceeds the 8 MiB cumulative read bound.
